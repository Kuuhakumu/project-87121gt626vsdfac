...
> Status tags: ✅ active · ⚠️ verify before registering · ⛔ retired/avoid
...
| Microsoft DP-600 Fabric Analytics Engineer | DP-600 | ~$165 USD | 100 min, proctored | ~700/1000 | 12 mo (free renewal) | 🟠 | ✅ |
...
- **Entry-level verdict:** The most widely recognized "first credential" for analyst roles. Employers see it as a baseline signal of foundational knowledge, not deep expertise. Worth completing early because it is low-cost (or free via aid), structured, and covers the full analyst workflow.
- **Source:** https://grow.google/certificates/data-analytics/ · https://www.coursera.org/professional-certificates/google-data-analytics
...
- **Validity:** No expiry
- **Skills covered:** Python, pandas, statistics, hypothesis testing, regression models, intro ML, Tableau
- **Entry-level verdict:** A genuine differentiator over the base Google cert. Covers material that appears in data science and ML engineer interviews. If you complete both Google certs, you have a defensible story for analyst AND junior data science roles. Higher ROI than the base cert alone.
- **Source:** https://www.coursera.org/professional-certificates/google-advanced-data-analytics
...
- **Passing score:** Not published (AWS uses scaled scoring; historically ~720/1000)
- **Validity:** 3 years
- **Skills covered:** AWS Glue, Redshift, S3, Lake Formation, Kinesis, Athena, data pipeline design, data security on AWS, query optimization
- **Entry-level verdict:** Strong differentiator for data engineering roles at AWS-heavy organizations. The Associate level is achievable without years of experience. $150 is competitive. 3-year validity is the best of any cloud cert listed here. Pair with hands-on AWS Free Tier projects.
- **Source:** https://aws.amazon.com/certification/certified-data-engineer-associate/
...
- **Validity:** 3 years
- **Skills covered:** ML model deployment on AWS (SageMaker), MLOps, data preparation for ML, model monitoring, security
- **Entry-level verdict:** The replacement for the retired MLS-C01 Specialty. Associate level = more accessible. Good for ML Engineer track. Note: this is deployment/MLOps-focused, not research-focused. Best paired with hands-on SageMaker projects.
- **Source:** https://aws.amazon.com/certification/certified-machine-learning-engineer-associate/
...
- **Skills covered:** Apache Spark, Delta Lake, Databricks workflows/pipelines, Lakehouse architecture, data engineering with Python/SQL on Databricks
- **Entry-level verdict:** Best Databricks cert for entry-level data engineering. Databricks is now ubiquitous in mid-to-large data teams alongside AWS/Azure/GCP. The $200 price is reasonable and the 70% passing bar is fair. Practical project experience on Databricks Community Edition is essential prep.
- **Source:** https://www.databricks.com/learn/certification/data-engineer-associate

---

### 12. Databricks Certified Data Analyst Associate ✅ 🟡
- **Full name:** Databricks Certified Data Analyst Associate
- **Price:** **$200 USD**
- **Format:** 90 minutes, 45 questions MC, proctored
- **Passing score:** 70%
- **Validity:** 2 years
- **Skills covered:** SQL on Databricks, Delta Lake queries, dashboards, Databricks SQL warehouse
- **Entry-level verdict:** 🟡 Nice-to-have for analyst roles at Databricks-heavy shops. Less universally recognized than PL-300 or Tableau certs for general analyst roles. Pursue if your target employer uses Databricks SQL as their primary analytics platform.
- **Source:** https://www.databricks.com/learn/certification/data-analyst-associate

---

### 13. Databricks Certified Machine Learning Associate ✅ 🟡
- **Full name:** Databricks Certified Machine Learning Associate
- **Price:** **$200 USD**
- **Format:** 90 minutes, 45 questions MC, proctored
- **Passing score:** 70%
- **Validity:** 2 years
- **Skills covered:** MLflow, feature engineering on Databricks, model training/tuning, AutoML, deployment within Databricks
- **Entry-level verdict:** 🟡 For ML Engineer track targeting Databricks environments. The ML Associate is reasonable prep but Databricks ML is less universally deployed than AWS SageMaker. Good second cert if you already have the Data Engineer Associate.
- **Source:** https://www.databricks.com/learn/certification/machine-learning-associate

---

### 14. Tableau Desktop Specialist ✅ 🟡
- **Full name:** Tableau Desktop Specialist
- **Issuer:** Salesforce/Tableau
- **Price:** ~$250 USD (Tableau blocked curl; price from Databricks cross-ref and known pricing)
...
### 15. Tableau Certified Data Analyst ✅ 🟡
- **Full name:** Tableau Certified Data Analyst
- **Price:** ~$250 USD
...
- **Issuer:** Snowflake
- **Price:** **$175 USD**
- **Format:** 100 minutes, ~100 questions; multiple choice/select
...
### 17. dbt Analytics Engineering Certification ✅ 🟡
- **Full name:** dbt Analytics Engineering Certification
- **Issuer:** dbt Labs (note: dbt Labs and Fivetran announced merger in 2026)
- **Price:** **$200 USD**
...
### 19. IBM Data Analyst Professional Certificate ✅ 🟡
- **Full name:** IBM Data Analyst Professional Certificate
- **Issuer:** IBM / Coursera
- **Price:** ~$49/month (Coursera)
- **Format:** 11 courses, completion-based; ~4 months at 10 hrs/week
- **Passing score:** N/A
- **Validity:** No expiry
...
|---|---|---|---|
| Azure Data Engineer Associate | DP-203 | **March 31, 2025** | Replaced by DP-700 (Fabric Data Engineer) |
| Azure Data Scientist Associate | DP-100 | ~2025 | Replaced by AI-102 / Fabric paths |
| AWS ML Specialty | MLS-C01 | **March 31, 2026** | Replaced by MLA-C01 (ML Engineer Associate) |

> **2021-era list check:** Any guide recommending DP-203, DP-100, or MLS-C01 is out of date. These three certs are confirmed retired as of June 2026.
...
*Researched: June 13, 2026 | Sources: official cert pages via curl*
*Microsoft Learn: learn.microsoft.com/certifications/*
*AWS: aws.amazon.com/certification/*
*Databricks: databricks.com/learn/certification/*
*Google/Coursera: grow.google/certificates/ · coursera.org*
*Snowflake: snowflake.com/certifications/*
*dbt Labs: getdbt.com/certifications/*
*IBM/Coursera: coursera.org/professional-certificates/ibm-data-science · ibm-data-analyst*
