...
|---|---|---|---|---|---|
| Bandit wargame | OverTheWire | overthewire.org/wargames/bandit/ | SSH into real boxes, CLI puzzles | Free | ✅ |
| Linux scenarios | KillerCoda | killercoda.com | Browser terminal, guided Linux tasks | Free | ✅ |

### Cloud provider free tiers / labs
| Lab | Platform | URL | What you do | Free | Status |
|---|---|---|---|---|---|
...
| MS Learn sandboxes | Microsoft | learn.microsoft.com/training/ | Free Azure sandbox, no card | Free | ✅ |
| Google Cloud Skills Boost | Google | cloudskillsboost.google | Qwiklabs hands-on (rebranded) | Freemium/credits | ⚠️ |

### Docker & containers
| Lab | Platform | URL | What you do | Free | Status |
|---|---|---|---|---|---|
| Play with Docker | Docker | labs.play-with-docker.com | Browser Docker host, 4-hr sessions | Free | ✅ |
...
| killer.sh | killer.sh | killer.sh | CKA/CKAD exam simulator | Paid (incl w/ exam) | ✅ |
...
| KodeKloud | Structured DevOps labs + courses | Freemium (free community tier) |
...
| Google Cloud Skills Boost | GCP Qwiklabs hands-on | Freemium/credits |
| HashiCorp tutorials | Terraform/Vault guided | Free |
| GitHub Skills | Actions / CI/CD in real repos | Free |

## Dead / paywalled since 2021
| Old resource | Status | Replacement |
|---|---|---|
| Katacoda | ❌ shut down Jun 2023 (tombstone page) | KillerCoda (same founders) |
| A Cloud Guru | acquired → redirects to pluralsight.com/cloud-guru (paid) | AWS Skill Builder, KodeKloud free tier, freeCodeCamp |
| Qwiklabs | rebranded → Google Cloud Skills Boost | (same, new name/URL) |
| learn.hashicorp.com | 308 redirect → developer.hashicorp.com/tutorials | (same, new URL) |

Sources: curl status-checked 2026-06-13. All 12 primary targets returned 200 or 403(live). Katacoda confirmed tombstone.
