...
| Role | Low | Mid | High |
|---|---|---|---|
| SOC Analyst T1 / Jr Security Analyst | 48,000 | 62,000 | 75,000 |
| Junior Penetration Tester | 60,000 | 75,000 | 90,000 |
| GRC / Compliance Analyst | 55,000 | 68,000 | 82,000 |
...
| Junior Pen Tester | 28,000 | 38,000 | 50,000 |
...
| Junior Pen Tester | 35,000 | 48,000 | 60,000 |
| GRC / Compliance | 34,000 | 44,000 | 55,000 |
| Cloud Security (entry) | 38,000 | 50,000 | 62,000 |

### Remote (USD, US-timezone)
| Role | Low | Mid | High |
|---|---|---|---|
| SOC Analyst T1 | 52,000 | 65,000 | 78,000 |
| GRC Analyst | 58,000 | 72,000 | 88,000 |
| Cloud Security (entry) | 68,000 | 85,000 | 100,000 |

## Baseline vs Differentiator Skills
**Baseline:** TCP/IP & OSI, DNS/HTTP(S), firewalls/VPN, Windows (AD, Event Viewer) + Linux CLI, any SIEM exposure, ticketing/ITSM, CIA triad & vuln lifecycle, Security+ (or equivalent).
**Differentiator:** Python log-parsing/automation, cloud security (IAM, CloudTrail/Activity Logs), detection engineering (Sigma/YARA), MITRE ATT&CK mapping, KQL/SPL fluency, documented home lab + CTFs, EU regulatory familiarity (NIS2/DORA) for EU roles.
...
## Top Hiring Sectors
MSSP/MDR (CrowdStrike, Arctic Wolf, Secureworks, Optiv, NCC Group, Orange Cyberdefense) · Big4/consulting (Deloitte, PwC, KPMG, EY, Accenture, Booz Allen) · Finance · Government/defense (clearance-gated) · Tech (competitive) · Healthcare/critical infra (ransomware-driven demand).

## Job Boards
**US:** LinkedIn, Indeed, USAJobs.gov, Dice, ClearanceJobs · **UK:** Reed, CWJobs, Totaljobs, NCSC Careers · **EU:** StepStone.de, Indeed (country), Xing, Jobteaser · **Cyber-specific:** infosec-jobs.com, CyberSecJobs.com, r/cybersecurity "Who's Hiring" threads.
