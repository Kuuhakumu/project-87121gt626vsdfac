...
[![Total Hours](https://img.shields.io/badge/Study%20Hours-500–700-green.svg)]()

## 🗺️ Roadmap at a Glance

```mermaid
graph TD
    P0[Phase 0: Pre-Flight Setup<br/>~20 hrs setup] --> P1[Phase 1: Foundations — A+<br/>~120 hrs]
    P1 --> P2[Phase 2: Networking & Security Core<br/>~180 hrs]
    P2 --> P3[Phase 3: Scripting, Logs & CTFs<br/>~100 hrs]
    P3 --> P4[Phase 4: Specialization<br/>~160 hrs]
    P4 --> P5[Phase 5: Portfolio & Job Hunt<br/>~100 hrs]
